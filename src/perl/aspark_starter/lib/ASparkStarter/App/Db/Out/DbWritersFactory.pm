package ASparkStarter::App::Db::Out::DbWritersFactory ; 
   ...
   our $objLogger       = {} ; 
	...
	# use ASparkStarter::App::Db::MariaDbWriter  ; 
   use ASparkStarter::App::Db::Out::DbWriterPostgres ; 
	...
	sub doInstantiate {
		...
		my $package_file     	= "ASparkStarter/App/Db/Out/$DbWriter.pm";
		my $objDbWriter   		= "ASparkStarter::App::Db::Out::$DbWriter";
