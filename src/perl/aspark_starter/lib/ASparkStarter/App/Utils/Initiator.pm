package ASparkStarter::App::Utils::Initiator ; 
...
=cut
	...
	sub doResolveMyConfFile {
      ...
      # cnf/aspark-starter.doc-pub-host.cnf
      # cnf/aspark-starter.dev.doc-pub-host.cnf
      # cnf/aspark-starter.tst.doc-pub-host.cnf
      # cnf/aspark-starter.prd.doc-pub-host.cnf
