package ASparkStarter::App::Utils::Logger ;
...
Perhaps a little code snippet.
    ...
    use ASparkStarter::Control::Utils::Logger ; 

    my $objLogger = ASparkStarter::Control::Utils::Logger->new( \$appConfig ) ;
    ...
...
=cut 
   ...
   sub doInitialize {
      ...
      $appConfig->{ 'PrintConsoleMsgs' } = 1 
		...
		$objTimer               = 'ASparkStarter::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
