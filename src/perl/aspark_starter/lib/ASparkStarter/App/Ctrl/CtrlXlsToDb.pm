package ASparkStarter::App::Ctrl::CtrlXlsToDb ; 
   ...
   use ASparkStarter::App::IO::In::XlsReader ; 
...
=cut
   ...
   sub doReadAndLoad {
      ...
      my $hsr2             = {} ; 
      my $objXlsReader     = 'ASparkStarter::App::IO::In::XlsReader'->new ( \$appConfig , \@tables ) ; 
      ...
      my $objDbWritersFactory = 'ASparkStarter::App::Db::Out::DbWritersFactory'->new( \$appConfig  ) ; 
