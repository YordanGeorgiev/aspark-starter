package ASparkStarter::App::Ctrl::CtrlDbToConflu ; 
   ...
   use ASparkStarter::App::IO::Out::ConfluWriter ; 
...
=cut
   ...
   sub doReadAndLoad {
      ...
      for my $table ( @tables ) { 
         ...
         my $objConfluWriter    = 'ASparkStarter::App::IO::Out::ConfluWriter'->new( \$appConfig ) ;
