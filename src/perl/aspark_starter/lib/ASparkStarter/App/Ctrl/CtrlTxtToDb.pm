package ASparkStarter::App::Ctrl::CtrlTxtToDb ; 
   ...
   use ASparkStarter::App::Db::Out::DbWritersFactory ; 
   use ASparkStarter::App::IO::In::TxtReaderFactory ; 
...
=cut
   ...
   sub doLoad {
      ...
      foreach my $table ( @tables ) {
         my $objTxtReaderFactory    = 'ASparkStarter::App::IO::In::TxtReaderFactory'->new( \$appConfig , $self ) ; 
         ...
         my $objDbWritersFactory    = 'ASparkStarter::App::Db::Out::DbWritersFactory'->new( \$appConfig , $self ) ; 
