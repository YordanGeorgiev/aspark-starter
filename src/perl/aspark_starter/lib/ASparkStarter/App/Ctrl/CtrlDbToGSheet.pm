package ASparkStarter::App::Ctrl::CtrlDbToGSheet ; 
   ...
   use ASparkStarter::App::IO::Out::GSheetWriter ; 
   use ASparkStarter::App::IO::In::UrlReader ; 
...
=cut
   ...
   sub doReadAndLoad {
      ...
      print "$url\n" ; 
      my $aspark_starter_proj = $ENV{'aspark_starter_project'} ; 
      my $home_dir = $ENV{'HOME'} ; 
      print "copy the string from your browser \n" ; 
      print 'echo <<CODE>> > ' . "$home_dir/.google/.code." . $aspark_starter_proj . "\n" ; 
      sleep 6 ; 

      my $code = $objFileHandler->doReadFileReturnString ( "$home_dir/.google/.code." . $aspark_starter_proj ) ; 
      print "\$code is $code" ; 
      sleep 3 ; 
      ...
      for my $table ( @tables ) { 
         ...
         my $objGSheetWriter    = 'ASparkStarter::App::IO::Out::GSheetWriter'->new( \$appConfig ) ;
