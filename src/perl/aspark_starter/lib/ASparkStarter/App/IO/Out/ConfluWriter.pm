package ASparkStarter::App::IO::Out::ConfluWriter ; 
   ...
   use ASparkStarter::App::IO::Out::UrlWriter ; 
   ...
   sub doBuildConfluTableFromHashRef {
      ...
      my $cookie_file =  "$home_dir/.conflu/.cookie." . $aspark_starter_proj  ; 
  
      unless ( -f $cookie_file ) { 
         $msg = 'did not find a cookie file for the issue tracker project: ' . $aspark_starter_proj ; 
         return ( 1 , $msg ) ; 
      }
...
$str_table = '<p>foobar</p>' ; 
      ...
      my $objUrlWriter = 'ASparkStarter::App::IO::Out::UrlWriter'->new ( \$appConfig ) ; 
