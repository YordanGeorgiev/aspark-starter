package ASparkStarter::App::IO::In::TxtReaderFactory ; 
   ...
   our $objLogger       = {} ; 
	...
	# use ASparkStarter::App::Db::TxtReaderWeekly  ; 
   use ASparkStarter::App::IO::In::TxtReader ;  
	...
	sub doInstantiate {
		...
		my $package_file     	= "ASparkStarter/App/IO/In/$TxtReader.pm";
		my $objTxtReader   		= "ASparkStarter::App::IO::In::$TxtReader";
