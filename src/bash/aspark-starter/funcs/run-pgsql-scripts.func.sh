# file: src/bash/aspark-starter/funcs/run-pgsql-scripts.func.sh

# v1.0.2
# ---------------------------------------------------------
# the docs	
# cat doc/txt/aspark-starter/funcs/run-pgsql-scripts.func.txt
# ---------------------------------------------------------
doRunPgsqlScripts(){
...
# eof file: src/bash/aspark-starter/funcs/run-pgsql-scripts.func.sh
